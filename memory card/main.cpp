...
void Control_Servo(int posicao_px, int posicao_ant, Servo servo)
{
  int pos;
  if (posicao_px < posicao_ant)
  {

    for (pos = posicao_px; pos <= posicao_ant; pos += 1)
    {
      servo.write(pos);
      estado_servo = "Expandindo";
      Serial.println(" ------- ");
      delay(15);
    }
  }
  if (posicao_px > posicao_ant)
    for (pos = posicao_ant; pos >= posicao_px; pos -= 1)
    {
      servo.write(pos);
      estado_servo = "Retraindo";
      Serial.println("++++++++");
      delay(15);
    }
  else if (posicao_px == posicao_ant)
  {
    estado_servo = "Parado";
    Serial.println(" ////////");
  }
        ...
        <div id="body" class="eyes-off">
            ...
            <div class="container_data" style="display: none" id="manual-m">
                <div id="servoM" class="p-control">
                    ...
                    <Input class="range" id = "positionServo" type="range" name="" value="0" min="0" max="100"
                ...
                <div id="bomba" class="p-control">
                    ...
                    <li class="tg-list-item">
                        <input class="tgl tgl-skewed" id="btn2" type="checkbox" onchange="toggleCheckbox(this)" />
...
void setup()
{
  ...
  server.on("/slider", HTTP_GET, [](AsyncWebServerRequest *request)
    ...
    Serial.println("Position:"+message.toInt());
